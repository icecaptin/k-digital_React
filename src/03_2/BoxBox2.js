    ...
    useEffect(() => {
        const fetchMV = async () => {
            try {
                ...
                const mvData = `https://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=f5eef3421c602c6cb7ea224104795888&targetDt=${formattedDate}`;
            ...
            <main className="container" data-theme="dark">
                <article>
                    ...
                    <table>
                        ...
                        <tbody>
                            <BoxRows2 movieList={mvData?.boxOfficeResult.dailyBoxOfficeList} />
                        </tbody>
                    </table>
                </article>
            </main>
